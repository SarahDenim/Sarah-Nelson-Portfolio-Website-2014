...
<div class="container">
	<h2>LEND</h2>
	<p>Welcome to the lending page. Here, you can browse loan applications which
	have been posted by other users. Use the filters to limit the results to 
	terms which are acceptable to you.</p>


	<div id="searchAmount"><h3> Search Loan Amount</h3><br />
...
$("#slider2").on({
	...
	<p id="lendToday"><img src="images/invest2.jpg"><br/>
	Post a loan offer here:
...
<script>
	...
	<div id="popUpForm"> 
		...
		<!--<form action="postloan.php" method="post" name="loanForm" id="inputs">-->
			<select name="offerType" id="offerType">
				<option value="borrow">I want to borrow money.</option>
				<option value="lend" selected="selected">I want to lend money.</option>
			</select>
			<br>
			...
			<?php 
				...
				$maxDate = date("Y-m-d", time()+(86400*365));
			?>
 ...
 <!-- Popup div ends here -->
	...
	<h2 id="h2borrow">BORROWERS SEEKING MONEY</h2>
